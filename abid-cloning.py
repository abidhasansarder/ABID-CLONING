...
def menu():
    ...
    print 'AUTHOR   : ABID HASAN SARDER'

    print 'FACEBOOK : Abid Hasan Sarder'

    print 'GITHUB     : https://github.com/abidhasansarder'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[ABID-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[ABID-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
